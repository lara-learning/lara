...
export const adminDeletionMailPayload = (admin: Admin, user: Trainee | Trainer | Admin | Mentor): EmailPayload => {
...
export const userToDeleteDeletionMailPayload = (userToDelete: Trainee | Trainer | Admin | Mentor): EmailPayload => {
  return {
 ...
 * @param userToDelete
 */
export const sendDeletionMail = async (userToDelete: Trainee | Mentor | Trainer | Admin): Promise<void> => {
